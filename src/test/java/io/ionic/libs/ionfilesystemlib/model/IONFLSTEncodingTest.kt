...
class IONFLSTEncodingTest {

    @Test
    fun `given utf8 is passed, the correct WithCharset encoding is returned`() = runTest {
        val input = "utf8"

        val result = IONFLSTEncoding.fromEncodingName(input)

        assertEquals(IONFLSTEncoding.WithCharset(Charsets.UTF_8), result)
    }
    ...
    fun `given utf16 is passed, the correct WithCharset encoding is returned`() = runTest {
        ...
        assertEquals(IONFLSTEncoding.WithCharset(Charsets.UTF_16), result)
    }
    ...
    fun `given ascii is passed, the correct WithCharset encoding is returned`() = runTest {
        ...
        assertEquals(IONFLSTEncoding.WithCharset(Charsets.US_ASCII), result)
    }
    ...
    fun `given null is passed, base64 encoding is returned`() = runTest {
        ...
        assertEquals(IONFLSTEncoding.Base64, result)
    }
